...
//        softAssert.assertEquals(expectedSelect,actualSelect);
        ...
        Thread.sleep(2000);
        WebElement jobName = driver.findElement(By.xpath("//td[@colspan='3'][contains(text(),'Product Manager')]"));
        String expectedJobName = jobName.getText();
        String actualJobName = "Product Manager";
        softAssert.assertEquals(expectedJobName, actualJobName);

        Thread.sleep(2000);
        WebElement fullTimeText = driver.findElement(By.xpath("//td[text()='Full Time Contract']"));
        softAssert.assertEquals(fullTimeText.getText(), "Full Time Contract");
        Thread.sleep(2000);
